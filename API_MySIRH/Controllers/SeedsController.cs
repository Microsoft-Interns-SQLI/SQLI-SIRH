...
namespace API_MySIRH.Controllers
{
    ...
    public class SeedsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Collaborateurs()
        {
            ...
            // filling tables
            await this._dataContext
                .Niveaux.AddRangeAsync(this.SeedNiveaux());
            await this._dataContext
                .Posts.AddRangeAsync(this.SeedPostes());
            await this._dataContext
                .TypeContrats.AddRangeAsync(this.SeedTypesContrat());
            await this._dataContext
                .SkillCenters.AddRangeAsync(this.SeedSkillCenters());
            await this._dataContext
                .Sites.AddRangeAsync(this.SeedSites());
            await this._dataContext
                .ModesRecrutements.AddRangeAsync(this.SeedModeRecrutement());
